...
import { PACKAGE_NAME, PLUGIN_MODES, getCodexMarketplaceManifest, getCodexPluginHooksConfig, getCodexPluginManifest, getCodexPluginMcpConfig, getPluginManifest, } from "../lib/plugin-metadata.mjs";
